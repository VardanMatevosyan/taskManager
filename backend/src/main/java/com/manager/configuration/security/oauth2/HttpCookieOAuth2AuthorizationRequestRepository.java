 ...
 * the application sends this parameter in the authorization request, and the OAuth2 provider returns this parameter unchanged in the OAuth2 callback.
 *
 ...
 *
 * To achieve this flow, the application needs to store the state parameter somewhere
